...
fn normalize_intent(text: &str) -> String {
    ...
    const MAP: &[(&str, &str)] = &[
        ...
        // ── New 149 intents (English mappings) ──
        // Web Framework Specifics
        ("graphql server", "graphql_server"), ("graphql api", "graphql_server"),
        ("grpc server", "grpc_server"), ("grpc service", "grpc_server"),
        ("cors middleware", "cors_middleware"), ("cors", "cors_middleware"),
        ("file upload", "file_upload"), ("upload file", "file_upload"),
        ("static file server", "static_file_server"), ("serve static files", "static_file_server"),
        ("websocket chat", "websocket_chat"), ("chat server", "websocket_chat"),
        ("health check", "health_check"), ("health endpoint", "health_check"),
        ("pagination", "pagination"), ("paginate", "pagination"),
        ("api versioning", "api_versioning"), ("version api", "api_versioning"),
        ("request logger", "request_logger"), ("log requests", "request_logger"),
        ("response cache", "response_cache"), ("http cache", "response_cache"),
        ("webhook handler", "webhook_handler"), ("webhook", "webhook_handler"),
        ("sse server", "sse_server"), ("server sent events", "sse_server"),
        ("multipart form", "multipart_form"), ("form data", "multipart_form"),
        ("cookie session", "cookie_session"), ("session cookie", "cookie_session"),
        ("oauth handler", "oauth_handler"), ("oauth2", "oauth_handler"), ("oauth", "oauth_handler"),
        ("api key auth", "api_key_auth"), ("api key", "api_key_auth"),
        ("graphql subscription", "graphql_subscription"),
        ("proxy server", "proxy_server"), ("reverse proxy", "proxy_server"),
        ("load balancer", "load_balancer"), ("round robin", "load_balancer"),
        // Database & Storage
        ("postgresql client", "postgresql_client"), ("postgres client", "postgresql_client"), ("asyncpg", "postgresql_client"),
        ("mongodb client", "mongodb_client"), ("mongo client", "mongodb_client"),
        ("connection pool", "connection_pool"), ("db pool", "connection_pool"),
        ("database migration", "database_migration"), ("schema migration", "database_migration"),
        ("transaction handler", "transaction_handler"), ("db transaction", "transaction_handler"),
        ("query builder", "query_builder"), ("sql builder", "query_builder"),
        ("key value store", "key_value_store"), ("kv store", "key_value_store"),
        ("time series db", "time_series_db"), ("time series", "time_series_db"),
        ("full text search", "full_text_search"), ("text search", "full_text_search"),
        ("data backup", "data_backup"), ("backup restore", "data_backup"),
        ("s3 client", "s3_client"), ("object storage", "s3_client"),
        ("sqlite wrapper", "sqlite_wrapper"), ("sqlite helper", "sqlite_wrapper"),
        ("data seeder", "data_seeder"), ("seed database", "data_seeder"),
        ("soft delete", "soft_delete"),
        ("audit log", "audit_log"), ("audit trail", "audit_log"),
        // Auth & Security
        ("password hasher", "password_hasher"), ("hash password", "password_hasher"), ("bcrypt", "password_hasher"),
        ("session manager", "session_manager"),
        ("role based access", "role_based_access"), ("rbac", "role_based_access"),
        ("token refresh", "token_refresh"), ("refresh token", "token_refresh"),
        ("csrf protection", "csrf_protection"), ("csrf token", "csrf_protection"),
        ("input sanitizer", "input_sanitizer"), ("xss prevention", "input_sanitizer"), ("sanitize input", "input_sanitizer"),
        ("ip whitelist", "ip_whitelist"), ("ip filter", "ip_whitelist"),
        ("two factor auth", "two_factor_auth"), ("2fa", "two_factor_auth"), ("totp", "two_factor_auth"),
        ("certificate pinning", "certificate_pinning"), ("cert pinning", "certificate_pinning"),
        ("secrets manager", "secrets_manager"), ("secret vault", "secrets_manager"),
        // Data Processing
        ("etl pipeline", "etl_pipeline"), ("extract transform load", "etl_pipeline"),
        ("batch processor", "batch_processor"), ("batch processing", "batch_processor"),
        ("stream processor", "stream_processor"), ("stream processing", "stream_processor"),
        ("map reduce", "map_reduce"), ("mapreduce", "map_reduce"),
        ("data validator", "data_validator"), ("schema validator", "data_validator"),
        ("csv to json", "csv_to_json"),
        ("json to xml", "json_to_xml"),
        ("text tokenizer", "text_tokenizer"), ("tokenizer", "text_tokenizer"),
        ("html to markdown", "html_to_markdown"),
        ("diff calculator", "diff_calculator"), ("text diff", "diff_calculator"),
        ("deduplicator", "deduplicator"), ("deduplicate", "deduplicator"),
        ("aggregator", "aggregator"), ("data aggregation", "aggregator"),
        ("data sampler", "data_sampler"), ("random sample", "data_sampler"),
        ("time window", "time_window"), ("sliding window", "time_window"),
        ("bloom filter", "bloom_filter"),
        // Testing & Quality
        ("mock server", "mock_server"), ("http mock", "mock_server"),
        ("test fixture", "test_fixture"),
        ("property test", "property_test"), ("property based testing", "property_test"),
        ("benchmark", "benchmark"), ("performance test", "benchmark"),
        ("coverage report", "coverage_report"), ("code coverage", "coverage_report"),
        ("test reporter", "test_reporter"),
        ("snapshot test", "snapshot_test"),
        ("integration suite", "integration_suite"),
        ("load tester", "load_tester"), ("load test", "load_tester"),
        ("chaos tester", "chaos_tester"), ("chaos test", "chaos_tester"),
        // CLI & DevTools
        ("progress bar", "progress_bar"),
        ("table formatter", "table_formatter"), ("format table", "table_formatter"),
        ("color output", "color_output"), ("colored output", "color_output"),
        ("interactive prompt", "interactive_prompt"), ("user prompt", "interactive_prompt"),
        ("file watcher", "file_watcher"), ("watch files", "file_watcher"),
        ("hot reloader", "hot_reloader"), ("hot reload", "hot_reloader"),
        ("dotenv loader", "dotenv_loader"), ("load dotenv", "dotenv_loader"),
        ("command runner", "command_runner"), ("run command", "command_runner"),
        ("project scaffolder", "project_scaffolder"), ("scaffold project", "project_scaffolder"),
        ("changelog generator", "changelog_generator"), ("generate changelog", "changelog_generator"),
        // Networking & Protocols
        ("tcp client", "tcp_client"),
        ("udp server", "udp_server"), ("udp echo", "udp_server"),
        ("dns resolver", "dns_resolver"), ("dns lookup", "dns_resolver"),
        ("smtp client", "smtp_client"), ("send email smtp", "smtp_client"),
        ("ftp client", "ftp_client"), ("ftp upload", "ftp_client"),
        ("mqtt client", "mqtt_client"), ("mqtt pub sub", "mqtt_client"),
        ("ssh client", "ssh_client"), ("ssh command", "ssh_client"),
        ("http client", "http_client"), ("http request", "http_client"),
        ("ping checker", "ping_checker"), ("ping host", "ping_checker"),
        ("port scanner", "port_scanner"), ("scan ports", "port_scanner"),
        // Concurrency & Scheduling
        ("thread pool", "thread_pool"), ("worker pool", "thread_pool"),
        ("mutex wrapper", "mutex_wrapper"), ("shared state mutex", "mutex_wrapper"),
        ("channel communication", "channel_communication"), ("mpsc channel", "channel_communication"),
        ("semaphore", "semaphore"), ("concurrency limiter", "semaphore"),
        ("retry with backoff", "retry_with_backoff"), ("exponential backoff", "retry_with_backoff"),
        ("circuit breaker", "circuit_breaker"),
        ("debouncer", "debouncer"), ("debounce", "debouncer"),
        ("throttler", "throttler"), ("throttle", "throttler"),
        ("parallel map", "parallel_map"),
        ("async queue", "async_queue"), ("task queue", "async_queue"),
        // System & OS
        ("env config", "env_config"), ("environment config", "env_config"),
        ("signal handler", "signal_handler"), ("handle signals", "signal_handler"),
        ("process manager", "process_manager"),
        ("system monitor", "system_monitor"), ("cpu monitor", "system_monitor"),
        ("disk usage", "disk_usage"), ("disk space", "disk_usage"),
        ("network info", "network_info"), ("network interface", "network_info"),
        ("temp file", "temp_file"), ("temporary file", "temp_file"),
        ("lockfile", "lockfile"), ("process lock", "lockfile"),
        ("daemon process", "daemon_process"), ("daemonize", "daemon_process"),
        ("log rotation", "log_rotation"), ("rotate logs", "log_rotation"),
        // Cryptography
        ("aes encrypt", "aes_encrypt"), ("aes decrypt", "aes_encrypt"), ("aes encryption", "aes_encrypt"),
        ("rsa keypair", "rsa_keypair"), ("rsa key", "rsa_keypair"),
        ("digital signature", "digital_signature"), ("sign verify", "digital_signature"),
        ("hmac auth", "hmac_auth"), ("hmac authentication", "hmac_auth"),
        ("random generator", "random_generator"), ("secure random", "random_generator"),
        // Patterns & Architecture
        ("repository pattern", "repository_pattern"), ("data repository", "repository_pattern"),
        ("service layer", "service_layer"), ("business logic layer", "service_layer"),
        ("dependency injection", "dependency_injection"), ("di container", "dependency_injection"),
        ("middleware chain", "middleware_chain"), ("middleware pipeline", "middleware_chain"),
        ("pub sub system", "pub_sub_system"), ("publish subscribe", "pub_sub_system"),
        ("command pattern", "command_pattern"), ("command undo", "command_pattern"),
        ("strategy pattern", "strategy_pattern"),
        ("decorator pattern", "decorator_pattern"),
        ("adapter pattern", "adapter_pattern"),
        ("chain of responsibility", "chain_of_responsibility"),
        // File & Format
        ("yaml parser", "yaml_parser"), ("parse yaml", "yaml_parser"),
        ("ini parser", "ini_parser"), ("parse ini", "ini_parser"),
        ("markdown renderer", "markdown_renderer"), ("render markdown", "markdown_renderer"),
        ("zip archive", "zip_archive"), ("zip compress", "zip_archive"),
        ("tar archive", "tar_archive"), ("tar gz", "tar_archive"),
        ("base64 codec", "base64_codec"), ("base64 encode", "base64_codec"), ("base64 decode", "base64_codec"),
        ("url encoder", "url_encoder"), ("url encode", "url_encoder"), ("url decode", "url_encoder"),
        ("qr code generator", "qr_code_generator"), ("qr code", "qr_code_generator"),
        ("barcode reader", "barcode_reader"), ("read barcode", "barcode_reader"),
        ("excel reader", "excel_reader"), ("read excel", "excel_reader"),
        // Math & Algorithm
        ("matrix multiply", "matrix_multiply"), ("matrix multiplication", "matrix_multiply"),
        ("fibonacci", "fibonacci"), ("fibonacci sequence", "fibonacci"),
        ("prime sieve", "prime_sieve"), ("sieve of eratosthenes", "prime_sieve"),
        ("graph bfs", "graph_bfs"), ("breadth first search", "graph_bfs"),
        ("graph dfs", "graph_dfs"), ("depth first search", "graph_dfs"),
        ("dijkstra", "dijkstra"), ("shortest path", "dijkstra"),
        ("lru cache", "lru_cache"),
        ("trie", "trie"), ("prefix tree", "trie"),
        ("linked list", "linked_list"),
        ("stack", "stack"), ("stack data structure", "stack"),
        ("heap", "heap"), ("min heap", "heap"), ("max heap", "heap"), ("priority queue", "heap"),
        ("hash map", "hash_map"), ("hash table", "hash_map"),
        ("ring buffer", "ring_buffer"), ("circular buffer", "ring_buffer"),
        ("skip list", "skip_list"),
